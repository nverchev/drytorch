...
class TestSQLConnectionFullCycle:
    ...
    def test_database_schema_created_correctly(self, tracker):
        ...
        experiments_columns = {col['name'] for col in
                               inspector.get_columns('experiments')}
        expected_columns = {'experiment_id',
                            'experiment_name',
                            'experiment_version',
                            'run_id'}
        assert experiments_columns == expected_columns

        sources_columns = {col['name'] for col in
                           inspector.get_columns('sources')}
        expected_columns = {'model_name',
                            'model_version',
                            'run_id',
                            'source_id',
                            'source_name',
    ...
    def test_epoch_metrics_stored_with_correct_values(self,
                                                      tracker,
                                                      example_epoch,
    ...
    def test_resume_run_functionality(self,
                                      resumed_tracker,
    ...
    def test_multiple_sources_in_same_run(self,
                                          resumed_tracker,
                                          call_model_event, ):
    ...
    def test_load_metrics_returns_correct_data(self,
                                               resumed_tracker,
                                               start_training_event):
        ...
        for source_name, (epochs, metrics_dict) in loaded_metrics.items():
    ...
    def test_load_metrics_with_max_epoch_filter(self,
                                                resumed_tracker,
                                                example_epoch,
                                                start_training_event):
    ...
    def test_load_metrics_with_resumed_sources(self,
                                               resumed_tracker,
                                               call_model_event,
                                               example_epoch,
                                               metrics_event,
        ...
        for source_name, (epochs, _) in loaded_metrics.items():
