"""Test for the registering module."""

import pytest

from src.dry_torch import exceptions
from src.dry_torch.registering import register_model, record_model_call
from src.dry_torch.registering import ALL_CALLERS, ALL_MODULES
